        ...
        <form action="{{ route('admin.settings.google-oauth.update') }}" method="POST">
            ...
            <div class="mb-8">
                ...
                <ol class="list-decimal pl-6 space-y-2 text-gray-700">
                    ...
                    <li>Adicione a URL de redirecionamento em "URIs de redirecionamento autorizados" (exemplo: https://seu-site.com.br/login/google/callback)</li>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        name="redirect"
                        id="redirect"
                        value="{{ $settings['google_redirect'] ?? old('redirect', url('/login/google/callback')) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        required
                    >
