...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Novo Pacote de Assinatura</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category"
                            ...
                            <option value="Básico" {{ old('category') == 'Básico' ? 'selected' : '' }}>Básico</option>
                            <option value="Avançado" {{ old('category') == 'Avançado' ? 'selected' : '' }}>Avançado</option>
